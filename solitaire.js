(function () {
  ...
  const WIN_GREETINGS = [
    "Сонечко, ти розклала все якнайкраще — пишаюся тобою. ♥",
    "Котику, уся колода слухняна, бо граєш ти. Молодчинка. ♥",
    "Киця моя розумниця — дім повний, серце теж. ♥",
    "Золотце, така гра — це вже майстерність, не випадковість. ✨",
    "Мила, ти сьогодні просто сяєш: усі карти вдома. ♥",
    "Зайчику, тихо й впевнено дійшла до фіналу — обіймаю думками. ♥",
    "Пташко, легко злетіла до перемоги. Відпочинь, ти цього варта. ♥",
    "Красунечко, кожен хід був у точку. Дякую за цю красу на столі. ♥",
    "Сонечко моє, ти зібрала пазл із п’ятдесяти двох шматочків — браво. ♦",
    "Котику пухнастий (настрійом), розумієш карти краще за багатьох. ♥",
    "Кицю, ти не просто виграла — ти прикрасила цю гру. ♥",
    "Люба, після такої партії можна гордо підняти підборідок. ♥",
    "Душечко, ти терпляча й гостра — ідеальний тандем для косинки. ♠♥",
    "Сонечко, нехай ця перемога нагає: ти справляєшся з усім. ✨",
    "Котику, тихий фінал — найкращий комплімент твоїм нервам. ♥",
    "Зіронько, усі чотири дому світяться завдяки тобі. ♥",
    "Маленька чарівнице (великої душі), карти тебе слухали. ♥",
    "Кицюня, грала м’яко, але до мети — як справжня акула в рожевому. ♦",
    "Сонечко, зігрійся цією перемогою — ти її на цілковито заслужила. ♥",
    "Котику, нагороджую титулом «королева дому» — повністю заслужено. ♥",
    "Мила киця, табло було твоїм полем бою — і ти його підкорила. ♥",
    "Золотце, дякую, що зробила цей вечір трохи світлішим. ♥",
    "Сонечко й зірки в домі — тобі, за цю ідеальну розкладку. ✨",
    "Котику милий, останній туз тебе чекав — і ти не підвела. ♥",
    "Пташечко, легкий політ до фіналу. Відпочивай, я горджуся. ♥",
  ];
  ...
  let rootEl = null;
  let winEl = null;
  /** Текст банера перемоги для цієї партії (щоб не мінявся при render). */
  let winGreetingLocked = null;
  ...
  function checkWinRender() {
    ...
    if (isWin()) {
      if (winGreetingLocked === null) {
        winGreetingLocked =
          WIN_GREETINGS[Math.floor(Math.random() * WIN_GREETINGS.length)];
      }
      winEl.hidden = false;
      winEl.textContent = winGreetingLocked;
    } else {
      winEl.hidden = true;
      winGreetingLocked = null;
    }
